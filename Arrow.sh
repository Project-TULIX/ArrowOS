...
if [ "$answer" != "${answer#[Yy]}" ] ;then
    ...
    echo " "
    repo init -u https://github.com/$ROM/android_manifest.git
    echo " "
    echo " Syncing repo "
    echo " "
    repo sync
    ...
    echo " "
    git clone https://github.com/Project-TULIX/arrow_device_xiaomi_tulip.git device/xiaomi/tulip && git clone https://github.com/Project-TULIX/device_xiaomi_tulip-common.git device/xiaomi/sdm660-common && git clone https://github.com/Project-TULIX/vendor_xiaomi_tulip-common.git vendor/xiaomi/sdm660-common && git clone https://github.com/Project-TULIX/vendor_xiaomi_tulip.git vendor/xiaomi/tulip && git clone https://github.com/OdSazib/halcyon_kernel_xiaomi_sdm660.git -b eas kernel/xiaomi/tulip && rm -rf hardware/qcom-caf/msm8998/display && rm -rf hardware/qcom-caf/msm8998/media && rm -rf hardware/qcom-caf/msm8998/audio && git clone https://github.com/Project-TULIX/hardware_qcom-caf_display_msm8998.git -b 11 hardware/qcom-caf/msm8998/display && git clone https://github.com/Project-TULIX/hardware_qcom-caf_media_msm8998.git -b 11 hardware/qcom-caf/msm8998/media && git clone https://github.com/Project-TULIX/hardware_qcom-caf_audio_msm8998.git -b 11 hardware/qcom-caf/msm8998/audio
    echo " "
